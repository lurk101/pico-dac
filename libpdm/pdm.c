...
static const int32_t vmin_04 = 32768 * -3 + 1;
static const int32_t pos_error_04 = 32768 * 6 - 1;
...
void pdm_begin(pdm_data* pdm_left, pdm_data* pdm_right, uint32_t pin_left, uint32_t pin_right,
    ...
    config_sm(pdm_left, pin_left, offset, clk_div);
    config_sm(pdm_right, pin_right, offset, clk_div);
